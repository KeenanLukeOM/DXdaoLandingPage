...
import {learnNavigation} from "./../../../utils/ui_constants";

const LearnNavigation = (props) => {
    return (
        <StyledLearnNavigation className={props.className && props.className}>
            {learnNavigation.map((elem, i) => {
                return (
                        <div
        ...
        </StyledLearnNavigation>
    )
};

const StyledLearnNavigation = styled.section`
    display: flex;
    margin-left: auto;
