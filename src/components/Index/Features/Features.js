    ...
    const features = [
        {
            ...
            title: <span>Decentralization<br/> at the core</span>,
            description: 'DXdao’s guiding philosophy is decentralization. Eliminating reliance on central operators ensures fair access to public infrastructure for all. DXdao’s products and governance are permissionless and decentralized, because they attract an organic community that builds resilliency. ',
            position: 'left',
            buttons: [
                {
                    label: 'LEARN MORE',
        ...
        },
        {
            ...
            buttons: [
                ...
                },
                {
                    type: 'secondary',
                    label: 'ALCHEMY',
                    infoText: 'DXdao’s governance portal',
                    to: 'https://alchemy.daostack.io/dao/0x519b70055af55a007110b4ff99b0ea33071c720a'  
                },
                {
                    type: 'secondary',
                    label: 'SNAPSHOT',
                    infoText: 'DXD signal proposals',
                    to: 'https://snapshot.org/#/dxd.eth'  
                }
            ]
        },
        {
               ...
               {features.map((feature, i) => {
                   return (
                    <Fragment key={i}>
                        ...
                        />
                        {i < 2 && (
                            <div className="connector-line-wrapper" data-aos="fade" data-aos-offset={'-100'}>
                                <section className="connector-line curve-line-desktop" id={`connector-line-${i + 1}`}/>
                            </div>
                        )}
                    </Fragment>);
               })}
